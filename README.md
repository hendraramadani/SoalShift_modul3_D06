...
- fungsi untuk menampilkan pilihan ketika standby mode
...
- membuat fungsi untuk menjalankan battle mode
	```
	void battle_mode() {
		while(1) {
			printf("Battle Mode\n");
...
- membuat fungsi untuk shop mode
...
- fungsi untuk menghitung status hunger
...
- fungsi untuk menghitung status hygiene
...
- fungsi untuk menghitung status health
